    ...
    return(
        <header className="w-[100%] flex justify-center gap-2 mt-6 z-50 fixed">
            ...
            style={{boxShadow: '0 5px 35px 0 rgba(0, 0, 0, 0.25), 0 -5px 35px 0 rgba(255, 255, 255, 0.04)' }}>
                ...
                <Link key={href} href={href} className={`w-12 h-12 rounded-full flex items-center justify-center hover:text-white/60 ${pathname === `${href}` ? 'text-white/100' : 'text-white/50'}`}>
                    {icon}
                </Link>
                ))}
            </nav>
